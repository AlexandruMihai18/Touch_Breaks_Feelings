...
#SBATCH --gpus=1
#SBATCH --job-name=gh_seggpt_touch
#SBATCH --ntasks=1
...
#   results/greatest_hits_val_seggpt_touch_results_<index>.csv
# Merge shards afterwards with, e.g.:
#   python scripts/merge_results.py results/greatest_hits_val_seggpt_touch_results_*.csv
#
